...
//for Heroku use the below segment and delete the duplicate below $cleardb_url = 
...
$dbuser = "as3676";//your ucid since we follow this pattern
$dbpass = "As14214200!";//database password generated or chosen per respective steps
$dbdatabase = "as3676";//your ucid since we follow this pattern
?>
